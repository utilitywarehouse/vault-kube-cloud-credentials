...
func (a *GCP) name() string {
	return "gcp"
}

func (a *GCP) secretIdentityAnnotation() string {
	return gcpServiceAccountAnnotation
}

func (a *GCP) secretPath() string {
	return a.Path + "/static-account/"
}

func (a *GCP) processUpdateEvent(e event.UpdateEvent) bool {
...
func (a *GCP) secretPayload(serviceAccount *corev1.ServiceAccount) (map[string]interface{}, error) {
...
func (a *GCP) renderPolicyTemplate(name string) (string, error) {
...
func (a *GCP) allow(namespace, serviceAccountEmail string) (bool, error) {
	return a.Rules.allow(namespace, serviceAccountEmail)
}
...
func (gcr *GCPRule) matchesServiceAccountEmail(roleName string) (bool, error) {
