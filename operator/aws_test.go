...
func skipVault(t *testing.T) {
	t.Skip("Skipping Vault tests, use of vault/vault to use vault.TestCluster is not supported: https://github.com/hashicorp/vault/issues/13386")
}
