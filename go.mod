...
//../../go/pkg/mod/github.com/hashicorp/vault@v1.11.3/vault/logical_system_paths.go:1793:4: unknown field 'TakesArbitraryInput' in struct literal of type framework.Path
